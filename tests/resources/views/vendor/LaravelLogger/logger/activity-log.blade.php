...
@section('template_title')
    {{ trans('laravel-logger.dashboard.title') }}
@endsection
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="{{ $containerClass }} {{ $bootstrapCardClasses }}">
                    <div style="background:#1B3155; color: white;" class="{{ $containerHeaderClass }}">
                        <div style=" display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span>
                                ...
                                <small>
                                    <sup class="label label-default">
                                        {{ $totalActivities }} {!! trans('laravel-logger.dashboard.subtitle') !!}
                                    </sup>
                                </small>
                            </span>
                          ...
                          <!--  <div class="btn-group pull-right btn-group-xs">
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <span class="sr-only">
                                        {!! trans('laravel-logger.dashboard.menu.alt') !!}
                                    </span>
                                </button>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{route('cleared')}}" class="dropdown-item">
                                        ...
                                        {!! trans('laravel-logger.dashboard.menu.show') !!}
                                    </a>
                                </div>
                                @else
                            ...
                            <span class="pull-right label label-default">
                                ...
                                <span class="hidden-sms">
                                    {!! trans('laravel-logger.dashboard.subtitle') !!}
                                </span>
                            </span>
                            @endif
