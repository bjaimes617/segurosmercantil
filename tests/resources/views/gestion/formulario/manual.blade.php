                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary card-tabs">
                                        ...
                                        {!! Form::open(['route' => ['gestion.manual.store'],'method' => 'post','id' => 'venta-polizas-manual','class' => 'text-sm form-horizontal  form-label-left','data-parsley-validate']) !!}
                                        <div class="card-body">
                                            {!! Form::token() !!}
                                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                                    <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">   
                                                                            <div class="input-group-prepend">
                                                                                {{ Form::select('nacionalidad',config('app.nacionalidad'),null, ['class' => 'form-control','id' => 'nacionalidad','required','data-parsley-required-message' => 'Este campo es obligatorio']) }} 
                                                                            </div> 
                                                                            {{ Form::text('n_cedula_manual',null,['class' => 'form-control input-number','id' =>'n_cedula_manual' ,'minlength'=>'6','maxlength'=>'13','data-href'=>route('check.cedula.manual'),'required','data-parsley-required-message' => 'Este campo es obligatorio']) }}
                                                                        </div> 
                                                                    </div>
                                                                </div>                                                               
                                                                <div class="col-md-6">                                            
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">   
                                                                            {{ Form::text('nomb1',null,['class' => 'form-control input-text','id' =>'nomb1','required','data-parsley-required-message' => 'Este campo es obligatorio']) }}
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">                                            
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">  
                                                                            {{ Form::text('nomb2',null,['class' => 'form-control input-text','id' =>'nomb2','data-parsley-required-message' => 'Este campo es obligatorio']) }}
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">                                            
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">  
                                                                            {{ Form::text('apelld1',null,['class' => 'form-control input-text','id' =>'apelld1' ,'required','data-parsley-required-message' => 'Este campo es obligatorio']) }}
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">                                            
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">  
                                                                            {{ Form::text('apelld2',null,['class' => 'form-control input-text','id' =>'apelld2','data-parsley-required-message' => 'Este campo es obligatorio']) }}
                                                                        </div> 
                                                                    </div>
                                                                </div>                                                                
                                                            </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                <div class="col-md-12">                                                                     
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">  
                                                                            {{ Form::text('fecha_de_nacimiento',null,['class' => 'form-control','required','Onblur'=>'CalcularEdad();','id' =>'fecha_de_nacimiento','data-parsley-required-message' => 'Este campo es obligatorio']) }}
                                                                            <div class="input-group-prepend">                                                                               
                                                                                {{ Form::text('edad',null,['class' => 'form-control','readonly','required','id' =>'edad']) }}
                                                                            </div>
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">                                                                     
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">  
                                                                            {{ Form::text('email_persol_tomador',null,['class' => 'form-control','id' =>'email_persol_tomador','required','data-parsley-required-message' => 'Este campo es obligatorio']) }}                                                                          
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">                                                                     
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">  
                                                                            {{ Form::text('email_trabajo_u_ofici_tomador',null,['class' => 'form-control','id' =>'email_trabajo_u_ofici_tomador','data-parsley-required-message' => 'Este campo es obligatorio']) }}                                                                          
                                                                        </div> 
                                                                    </div>
                                                                </div>                                                                                                                          
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">                                            
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">  
                                                                    {{ Form::text('apellcasada',null,['class' => 'form-control', 'readonly','id' =>'apellcasada','data-parsley-required-message' => 'Este campo es obligatorio']) }}
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">                                            
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">  
                                                                    {{ Form::select('sexo',config('app.sexo'),null, ['class' => 'form-control','id' => 'sexo','required','placeholder'=>'[Seleccione]','data-parsley-required-message' => 'Este campo es obligatorio']) }} 
                                                                </div> 
                                                            </div>
                                                        </div>                                                              
                                                        <div class="col-md-4">                                            
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">  
                                                                    {{ Form::select('cd_edo_civil',config('app.cd_edo_civil'),null, ['class' => 'form-control','id' => 'cd_edo_civil','placeholder'=>'[Seleccione]','required','data-parsley-required-message' => 'Este campo es obligatorio']) }} 
                                                                </div> 
                                                            </div>
                                                        </div> 
                                                        ...
                                                        <div class="col-md-6">                                                                     
                                                            <div class="form-group">
                                                                {!! Form::label('num_telefono_hab_tomador', 'Telefono de Habitación', ['class' => 'col-form-label']) !!}  <span class="required" style="color:red;"> * </span>                                                            
                                                                <div class="input-group">  
                                                                    {{ Form::select('cd_area_num_telefono_habitacion_tomador',$cod, null,['class' => 'form-control input-number','required','id' => 'cd_area_num_telefono_habitacion_tomador','placeholder'=>'[Seleccione]','data-parsley-required-message' => 'Este campo es obligatorio']) }} 
                                                                    <div class="input-group-prepend">
                                                                        {{ Form::text('num_telefono_hab_tomador',null, ['class' => 'form-control input-number','minlength'=>'7','required','maxlength'=>'7','id' => 'num_telefono_hab_tomador','data-parsley-required-message' => 'Este campo es obligatorio']) }} 
                                                                    </div> 
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">                                                                     
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">                                                                          
                                                                    {{ Form::select('cd_area_num_telefono_trab_ofic_tomador',$cod,null, ['class' => 'form-control','id' => 'cd_area_num_telefono_trab_ofic_tomador','required','data-parsley-required-message' => 'Este campo es obligatorio']) }} 
                                                                    <div class="input-group-prepend">
                                                                        {{ Form::text('num_telefono_trab_ofic_tomador',null, ['class' => 'form-control input-number','minlength'=>'7','maxlength'=>'7','id' => 'num_telefono_trab_ofic_tomador','data-parsley-required-message' => 'Este campo es obligatorio']) }} 
                                                                    </div> 
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">                                                                     
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">  
                                                                    {{ Form::text('num_celular_pers_tomador',null, ['class' => 'form-control input-number','required','id' => 'num_celular_pers_tomador','minlength'=>'10','maxlength'=>'10','required','data-parsley-required-message' => 'Este campo es obligatorio']) }}                                                                   
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">                                                                     
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">  
                                                                    {{ Form::text('num_celular_trab_tomador',null, ['class' => 'form-control input-number','id' => 'num_celular_trab_tomador','minlength'=>'10','maxlength'=>'10','data-parsley-required-message' => 'Este campo es obligatorio']) }}                                                                   
                                                                </div> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                {!! Form::label('domicilioadomanual', 'Instrumento de Domicilio', ['class' => 'col-form-label']) !!} <span class="required" style="color:red;"> * </span>                                                             
                                                        ...
                                                        <div class="col-md-6"> 
                                                            <div class="form-group">
                                                                {!! Form::label('newbancomanual', 'Institución Bancaria', ['class' => 'col-form-label']) !!} <span class="required" style="color:red;"> * </span>                                                              
                                                        ...
                                                        <div class="col-md-6"> 
                                                            <div class="form-group">
                                                                {!! Form::label('tipoinstrumentonewmanual', 'Tipo de Instrumento', ['class' => 'col-form-label']) !!}  <span class="required" style="color:red;"> * </span>                                                              
                                                                <div class="input-group">  
                                                                    {{ Form::select('tipoinstrumentonewmanual',[],null, ['class' => 'form-control','required','id' => 'tipoinstrumentonewmanual','data-parsley-required-message' => 'Este campo es obligatorio']) }}                                                                   
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6"> 
                                                            <div class="form-group">
                                                                {!! Form::label('instrumentonewmanual', 'Instrumento para Domiciliar', ['class' => 'col-form-label']) !!} <span class="required" style="color:red;"> * </span>                                                               
                                                                <div class="input-group">  
                                                                    {{ Form::text('instrumentonewmanual',null, ['class' => 'form-control input-number','required','maxlength' => '20','id' => 'instrumentonewmanual','data-parsley-required-message' => 'Este campo es obligatorio']) }}                                                                   
                                                                </div> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <table id="tableproductos" class="table table-sm table-bordered text-center">
                                                                ...
                                                                <tbody>                                                                  
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <select id="banco{{$plan->id}}" name="banco{{$plan->id}}" disabled class="form-control readonly nuevosbancos">
                                                                                <option value=''>[SELECCIONE]</option>
                                                                                @foreach($banco as $ban)
                                                                                <option value='{{$ban->id}}' >{{$ban->banco}}</option>
                                                                                @endforeach
