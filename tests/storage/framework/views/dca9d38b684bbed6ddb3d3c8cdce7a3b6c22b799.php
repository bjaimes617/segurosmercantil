...
<?php $__env->startSection('consolidado.index','active'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">  
                                            ...
                                            <span class="input-group-append">
                                                <button type="button" id="consolidadoSearch" data-href="<?php echo e(route('consolidado.show')); ?>" class="btn btn-primary btn-block"><i class="fas fa-search"></i> Generar</button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12"  id="displaytable">
                                    ...
                                    <table id="datatables" class="table table-bordered table-hover text-center">
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                               <td><?php echo e($datas["nro"]); ?></td>
                                               <td><?php echo e($datas["nombre"]); ?></td>
                                               <td><?php echo e($datas["generadas"]); ?></td>
                                               <td><?php echo e($datas["globales"]); ?></td>
                                           </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/segurosmercantil/source/resources/views/gestion/ventas/consolidado.blade.php ENDPATH**/ ?>