<?php $__env->startSection('title', 'Reporteria General'); ?>
<?php $__env->startSection('menu_reportes','menu-open'); ?>
<?php $__env->startSection('reportes','active'); ?>
<?php $__env->startSection('reportes.index','active'); ?>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">   
                            <?php echo Form::open(['route' => 'reportes.store','method' => 'post','id' => 'DescargarReportes','class' => 'form-horizontal  form-label-left','data-parsley-validate','enctype' => 'multipart/form-data']); ?>
                                ...
                                <div class="col-md-6">                                                                     
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">  
                                            ...
                                            <?php echo e(Form::text('rango_fecha',null, ['class' => 'form-control calendarangofecha','id' => 'rango_fecha','placeholder'=>'DD/MM/YYYY','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                   
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">                                                                     
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/segurosmercantil/source/resources/views/reportes/index.blade.php ENDPATH**/ ?>