            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="text-center user-footer">
                    <div class="btn-group-lg btn-group">
                        ...
                        <a href="<?php echo e(asset('/source/storage/app/public/manual_usuario_infinity.pdf')); ?>" class="btn btn-default btn-flat"><i class="far fa-question-circle"></i> <span class="right badge badge-info">new</span></a>
...
</div><?php /**PATH C:\xampp7-4\htdocs\segurosmercantil\source\resources\views/partials/headers.blade.php ENDPATH**/ ?>