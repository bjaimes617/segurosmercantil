...
class ExportCSVida implements  FromCollection, ShouldAutoSize, WithHeadings, WithMapping, WithChunkReading, WithCustomCsvSettings {
    ...
    public function headings(): array {
     $columns = [
        ...
        "67- TP_CUENTA",	
        "68-TP_TARJETA",	
        "69- FE_VENCIMIENTO_TARJETA",	
        "70- DIGITO VERIFICADOR",
        "71-Convenio",
        "72-Aliado",
    ...
    public function map($data): array{               
        ...
        "65- CD_BANCO"                      =>$data->banco,
        "66- NU_CUENTA"                     =>strval($data->cuenta),
        "67- TP_CUENTA"                 => $data->tipo_cuenta_domiciliar,
        "68-TP_TARJETA"                 => $data->tipo_tdc_domiciliar,
        "69- FE_VENCIMIENTO_TARJETA"    => $data->fecha_vencimiento_tdc_domiciliar,	
        "70- DIGITO VERIFICADOR"        => null,
        "71-Convenio"                   => null,
        "72-Aliado"                     => null,
