    ...
    */
    ...
    public function headings(): array {
     $columns = [
         ...
         "58- TP_CUENTA",
         "59-TP_TARJETA",
         "60- FE_VENCIMIENTO_TARJETA",
         "61- DIGITO VERIFICADOR",
         "62-990037_Convenio",
         "63-990038_Aliado"
    ...
    public function map($data): array{               
        ...
        "56- CD_BANCO"               => $data->banco,
         "57- NU_CUENTA"             => strval($data->cuenta),
         "58- TP_CUENTA"             => $data->tipo_cuenta_domiciliar,
         "59-TP_TARJETA"                => $data->tipo_tdc_domiciliar,
         "60- FE_VENCIMIENTO_TARJETA"   => $data->fecha_vencimiento_tdc_domiciliar,	
         "61- DIGITO VERIFICADOR"       => null,
         "62-990037_Convenio"           => null,
         "63-990038_Aliado"             => null,
        ];
        return $columns;
    }
}
