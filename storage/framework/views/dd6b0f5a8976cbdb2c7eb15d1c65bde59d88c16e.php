                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Visualizando informacion de: <b><?php echo e($client->nomb1); ?> <?php echo e($client->nomb2); ?> <?php echo e($client->apelld1); ?> <?php echo e($client->apelld2); ?></b>  </h3>
                            <p class="float-right">                                
                                <button type="button" 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary card-tabs">
                                        ...
                                        <?php echo Form::open(['route' => ['gestion.store',$client->id],'method' => 'post','id' => 'venta-polizas','class' => 'text-sm form-horizontal  form-label-left','data-parsley-validate']); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6"> 
                                                            <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">   
                                                                            <div class="input-group-prepend">
                                                                                <?php echo e(Form::select('nacionalidad',config('app.nacionalidad'),$client->nacionalidad, ['class' => 'form-control','id' => 'nacionalidad','required','data-parsley-required-message' => 'Este campo es obligatorio'])); ?> 
                                                                            </div> 
                                                                            <?php echo e(Form::text('n_cedula',$client->n_cedula,['class' => 'form-control input-number','readonly','id' =>'n_cedula' ,'minlength'=>'6','maxlength'=>'13','required','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>
                                                                ...
                                                                <!--- <div class="col-md-6">                                            
                                                                    <div class="form-group">
                                                                        <?php echo Form::label('fechavencedula', 'Fecha Vencimiento Cedula', ['class' => 'col-form-label']); ?> <span class="required" style="color:red;"> * </span>                                                               
                                                                        <div class="input-group mb-3">
                                                                            <?php echo e(Form::text('fechavencedula',$client->fe_vencimiento_documento != null ? date('m-Y',strtotime($client->fe_vencimiento_documento)) : null,['class' => 'form-control','id' =>'fechavencedula','required','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>
                                                                ...
                                                                <div class="col-md-6">                                            
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">   
                                                                            <?php echo e(Form::text('nomb1',$client->nomb1,['class' => 'form-control input-text','id' =>'nomb1','required','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>
                                                                ...
                                                                <div class="col-md-6">                                            
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">  
                                                                            <?php echo e(Form::text('nomb2',$client->nomb2,['class' => 'form-control input-text','id' =>'nomb2','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>
                                                                ...
                                                                <div class="col-md-6">                                            
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">  
                                                                            <?php echo e(Form::text('apelld1',$client->apelld1,['class' => 'form-control input-text','id' =>'apelld1' ,'required','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>
                                                                ...
                                                                <div class="col-md-6">                                            
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">  
                                                                            <?php echo e(Form::text('apelld2',$client->apelld2,['class' => 'form-control input-text','id' =>'apelld2','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">                                                                     
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">  
                                                                            <?php echo e(Form::text('fecha_de_nacimiento',date('d/m/Y',strtotime($client->fecha_de_nacimiento)),['class' => 'form-control','required','Onblur'=>'CalcularEdad();','id' =>'fecha_de_nacimiento','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>

                                                                            <div class="input-group-prepend">                                                                               
                                                                                <?php echo e(Form::text('edad',null,['class' => 'form-control','readonly','id' =>'edad'])); ?>
                                                                ...
                                                                <div class="col-md-12">                                                                     
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">  
                                                                            <?php echo e(Form::text('email_persol_tomador',$client->email_persol_tomador,['class' => 'form-control','id' =>'email_persol_tomador','required','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                          
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">                                                                     
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group mb-3">  
                                                                            <?php echo e(Form::text('email_trabajo_u_ofici_tomador',$client->email_trabajo_u_ofici_tomador,['class' => 'form-control','id' =>'email_trabajo_u_ofici_tomador','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                          
                                                                        </div> 
                                                                    </div>
                                                                </div>                                                                                                                          
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">                                            
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">  
                                                                    <?php echo e(Form::text('apellcasada',$client->apellcasada,['class' => 'form-control',$client->cd_edo_civil !=  "C" ? 'readonly': '','id' =>'apellcasada','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>
                                                        ...
                                                        <div class="col-md-4">                                            
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">  
                                                                    <?php echo e(Form::select('sexo',config('app.sexo'),$client->cd_sexo, ['class' => 'form-control','id' => 'sexo','required','data-parsley-required-message' => 'Este campo es obligatorio'])); ?> 
                                                                    </div> 
                                                            </div>
                                                        </div>                                                              
                                                        <div class="col-md-4">                                            
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">  
                                                                    <?php echo e(Form::select('cd_edo_civil',config('app.cd_edo_civil'),$client->cd_edo_civil, ['class' => 'form-control','id' => 'cd_edo_civil','required','data-parsley-required-message' => 'Este campo es obligatorio'])); ?> 
                                                                </div> 
                                                            </div>
                                                        </div> 
                                                        ...
                                                        <div class="col-md-6">                                                                     
                                                            <div class="form-group">
                                                                <?php echo Form::label('num_telefono_hab_tomador', 'Telefono de Habitación', ['class' => 'col-form-label']); ?>                                                              
                                                                <div class="input-group mb-3">  
                                                                    <?php echo e(Form::select('cd_area_num_telefono_habitacion_tomador',$cod,$client->cd_area_num_telefono_habitacion_tomador, ['class' => 'form-control','id' => 'cd_area_num_telefono_habitacion_tomador','placeholder'=>'[Seleccione]','data-parsley-required-message' => 'Este campo es obligatorio'])); ?> 
                                                                    <div class="input-group-prepend">
                                                                        <?php echo e(Form::text('num_telefono_hab_tomador',$client->num_telefono_hab_tomador, ['class' => 'form-control input-number','minlength'=>'7','maxlength'=>'7','id' => 'num_telefono_hab_tomador','data-parsley-required-message' => 'Este campo es obligatorio'])); ?> 
                                                                    </div> 
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">                                                                     
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">  
                                                                        <?php echo e(Form::select('cd_area_num_telefono_trab_ofic_tomador',$cod,$client->cd_area_num_telefono_trab_ofic_tomador, ['class' => 'form-control','id' => 'cd_area_num_telefono_trab_ofic_tomador','placeholder'=>'[Seleccione]','data-parsley-required-message' => 'Este campo es obligatorio'])); ?> 
                                                                    <div class="input-group-prepend">
                                                                        <?php echo e(Form::text('num_telefono_trab_ofic_tomador',$client->num_telefono_trab_ofic_tomador, ['class' => 'form-control input-number','minlength'=>'7','maxlength'=>'7','id' => 'num_telefono_trab_ofic_tomador','data-parsley-required-message' => 'Este campo es obligatorio'])); ?> 
                                                                    </div> 
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">                                                                     
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">  
                                                                    <?php echo e(Form::text('num_celular_pers_tomador',$client->num_celular_pers_tomador, ['class' => 'form-control input-number','id' => 'num_celular_pers_tomador','minlength'=>'10','maxlength'=>'10','required','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                   
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">                                                                     
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">  
                                                                    <?php echo e(Form::text('num_celular_trab_tomador',$client->num_celular_trab_tomador, ['class' => 'form-control input-number','id' => 'num_celular_trab_tomador','minlength'=>'10','maxlength'=>'10','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                   
                                                                </div> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <table id="tableproductos" class="table table-sm table-bordered text-center">
                                                                ...
                                                                <tbody>                                                                  
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <select id="banco<?php echo e($plan->id); ?>" name="banco<?php echo e($plan->id); ?>" disabled class="form-control readonly">
                                                                                ...
                                                                                <option value='<?php echo e($ban->id); ?>' <?php if($ban->codigo == substr($client->num_cuenta_asociar_inst_bancario_sinencriptar, 0,4)): ?>
                                                                                    selected 
                                                                                    <?php endif; ?> ><?php echo e($ban->banco); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </select>
                                                                        </td>
                                                                        <td><!--$client->num_cuenta_asociar_inst_bancario_sinencriptar,10,20)--->
                                                                            <?php echo e(Form::hidden('instrumento'.$plan->id,$client->num_cuenta_asociar_inst_bancario_sinencriptar,
                                                                            ...
                                                                            <?php echo e(Form::hidden('tipocuenta'.$plan->id, $client->tipo_cuenta_domiciliar,
                                                                                ['class'    => 'form-control',
                                                                                'data-plan' => $plan->id,                                                                                
                                                                                'id'        =>'tipocuenta'.$plan->id ])); ?> 

                                                                            <p style="margin:0px;" id="texttipocuenta<?php echo e($plan->id); ?>"><?php echo e($client->tipo_cuenta_domiciliar); ?></p>
                                                                            <p style="margin:0px;"id="textdisplay<?php echo e($plan->id); ?>"></p>                                                                              
                                                                        </td>
                                                                        <td>
                                                                            <button type="button" 
                                                                                    ...
                                                                                    onclick="EditDomicilio(<?php echo e($plan->id); ?>);"><i class="fa fa-edit"></i></button>   
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php echo Form::label('domicilioadoa', 'Instrumento de Domicilio', ['class' => 'col-form-label']); ?>                                                               
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            <?php echo Form::label('newbanco', 'Institución Bancaria', ['class' => 'col-form-label']); ?>                                                               
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            <?php echo Form::label('tipoinstrumentonew', 'Tipo de Instrumento', ['class' => 'col-form-label']); ?>                                                               
                                            <div class="input-group mb-3">  
                                                <?php echo e(Form::select('tipoinstrumentonew',[],null, ['class' => 'form-control','id' => 'tipoinstrumentonew','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                   
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            <?php echo Form::label('instrumentonew', 'Instrumento para Domiciliar', ['class' => 'col-form-label']); ?>                                                               
                                            <div class="input-group mb-3">  
                                                <?php echo e(Form::text('instrumentonew',null, ['class' => 'form-control input-number','maxlength' => '20','id' => 'instrumentonew','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                   
                                            </div> 
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="modal-incidencias">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <?php echo Form::open(['route' => ['gestion.store.incidencias',$client->id],'method' => 'post','id' => 'incidencias','class' => 'text-sm form-horizontal  form-label-left','data-parsley-validate']); ?>
                            ...
                            <div class="modal-body text-center">
                                <div class="row">
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            <?php echo Form::label('tipificacion1', 'Tipificación 1', ['class' => 'col-form-label']); ?> <span class="required" style="color:red;"> * </span>                                                                                                                             
                                            <div class="input-group mb-3">  
                                                <?php echo e(Form::select('tipificacion1', $tipificacion1,null, ['class' => 'form-control','required','id' => 'tipificacion1','placeholder'=>'[SELECCIONE]','data-href'=>route('gestion.tipificaciones.search'),'data-parsley-required-message' => 'Este campo es obligatorio'])); ?>
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            <?php echo Form::label('tipificacion2', 'Tipificación 2', ['class' => 'col-form-label']); ?> <span class="required" style="color:red;"> * </span>                                                                                                                             
                                            <div class="input-group mb-3">  
                                                <?php echo e(Form::select('tipificacion2', [],null, ['class' => 'form-control','id' => 'tipificacion2','required','placeholder'=>'[SELECCIONE TIPIFICACION 1]','data-parsley-required-message' => 'Este campo es obligatorio', 'data-href' =>  route('mercantil.tipificacion3')])); ?>                                                                   
                                            </div> 
                                        </div>
                                    </div>
                                       <div class="col-md-6"> 
                                        <div class="form-group">
                                            <?php echo Form::label('tipificacion3', 'Tipificación 3', ['class' => 'col-form-label']); ?> <span class="required" style="color:red;"> * </span>                                                                                                                             
                                            <div class="input-group mb-3">  
                                                <?php echo e(Form::select('tipificacion3', [],null, ['class' => 'form-control','id' => 'tipificacion3','required','placeholder'=>'[SELECCIONE TIPIFICACION 2]','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                   
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            <?php echo Form::label('identificador_llamada', 'Identificador de Llamada', ['class' => 'col-form-label']); ?> <span class="required" style="color:red;"> * </span>                                                              
                                            <div class="input-group mb-3">  
                                                <?php echo e(Form::text('identificador_llamada',null, ['class' => 'form-control','required','id' => 'identificador_llamada','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                   
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="col-md-6" id="displayagendamiento" style="display: none;"> 
                                        <div class="form-group">
                                            <?php echo Form::label('agendamiento', 'Fecha Agendamiento', ['class' => 'col-form-label']); ?> <span class="required" style="color:red;"> * </span>                                                                                                                             
                                            <div class="input-group mb-3">  
                                                <div class="input-group-prepend">  
                                                    <span class="input-group-text" id="basic-addon11"><i class="fa fa-calendar"></i></span>
                                                </div>
                                                <?php echo e(Form::text('agendamiento',null, ['class' => 'form-control','id' => 'agendamiento','placeholder'=>'DD/MM/YYYY','data-parsley-required-message' => 'Este campo es obligatorio'])); ?>                                                                   
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12"> 
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">  
                                                <?php echo Form::text('comentario',null,
                                                ['class' => 'form-control',
                                                'style'=>'resize:none;',
                                                'id' =>'comentario',
                                                'required',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/SISTEMAS_ACTUALIZADOS 8.2/segurosmercantil8/resources/views/gestion/formulario/index.blade.php ENDPATH**/ ?>