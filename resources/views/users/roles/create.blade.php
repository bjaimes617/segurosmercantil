...
@section('title', 'Añadir Roles de usuario al Sistema')
@section('content')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        {!! Form::open(['route' => 'roles.store','method' => 'post','id' => 'create-permission','class' => 'form-horizontal  form-label-left','data-parsley-validate']) !!}
                        {!! Form::token() !!}
                        <!-- /.card-header -->
