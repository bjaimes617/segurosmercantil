...
@section('title', 'Reporteria TXT por Planes Activos')
@section('menu_reportes','menu-open')
@section('reportes','active')
@section('reportes.txt','active')
@section('content')
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Generación de TXT por Planes</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">   
                            {!! Form::open(['route' => 'reportes.store.txt','method' => 'post','id' => 'DescargarReportes','class' => 'form-horizontal  form-label-left','data-parsley-validate','enctype' => 'multipart/form-data']) !!}
                            {!! Form::token() !!}
                            <div class="row">
                                <div class="col-md-6">                                                                     
